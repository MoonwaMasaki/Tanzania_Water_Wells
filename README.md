...
```
├── data/
│   ├── training_set_values.csv       # Raw feature data (download from DrivenData)
│   ├── training_set_labels.csv       # Raw target labels (download from DrivenData)
│   └── processed/                    # Cleaned train/val/test splits (generated by 01_EDA.ipynb)
│       ├── X_train.csv
│       ├── X_val.csv
│       ├── X_test.csv
│       ├── y_train.csv
